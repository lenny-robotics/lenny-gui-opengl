...
void Renderer::drawRoundedCuboid(const Eigen::Vector3d& COM, const Eigen::QuaternionD& orientation, const Eigen::Vector3d& dimensions, const double& radius,
                                 const Eigen::Vector4d& color) const {
    const tools::Transformation trafo(COM, orientation);
    ...
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(Eigen::Vector3d::UnitX())),
              orientation * Eigen::QuaternionD(tools::utils::rotZ(-PI / 2.0)), Eigen::Vector2d(dimensions[1], dimensions[2]), color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(-Eigen::Vector3d::UnitX())),
              orientation * Eigen::QuaternionD(tools::utils::rotZ(PI / 2.0)), Eigen::Vector2d(dimensions[1], dimensions[2]), color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(Eigen::Vector3d::UnitY())),
              orientation * Eigen::QuaternionD(tools::utils::rotX(0.0)), Eigen::Vector2d(dimensions[0], dimensions[2]), color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(-Eigen::Vector3d::UnitY())),
              orientation * Eigen::QuaternionD(tools::utils::rotX(PI)), Eigen::Vector2d(dimensions[0], dimensions[2]), color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(Eigen::Vector3d::UnitZ())),
              orientation * Eigen::QuaternionD(tools::utils::rotX(-PI / 2.0)), Eigen::Vector2d(dimensions[0], dimensions[1]), color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(0.5 * drawDim.cwiseProduct(-Eigen::Vector3d::UnitZ())),
              orientation * Eigen::QuaternionD(tools::utils::rotX(PI / 2.0)), Eigen::Vector2d(dimensions[0], dimensions[1]), color);
}
...
void Renderer::drawRoundedPlane(const Eigen::Vector3d& COM, const Eigen::QuaternionD& orientation, const Eigen::Vector2d& dimensions, const double& radius,
    ...
    drawPlane(trafo.getGlobalCoordinatesForPoint(Eigen::Vector3d(0.0, radius, 0.0)), orientation * Eigen::QuaternionD(tools::utils::rotX(0.0)), dimensions,
              color);
    drawPlane(trafo.getGlobalCoordinatesForPoint(Eigen::Vector3d(0.0, -radius, 0.0)), orientation * Eigen::QuaternionD(tools::utils::rotX(PI)), dimensions,
              color);
}
